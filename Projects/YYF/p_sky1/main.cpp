...
int main() {
    ...
    std::string glb3 = "retro_gun_01.glb";
    std::string glb4 = "stylized_gun.glb";
    std::string glb5 = "covid-19.glb"; 
    std::string glb6 = "mimivirus.glb";
    std::string glb7 = "virus.glb"; 
    std::string glb8 = "virus_bomb.glb"; 
    std::string glb9 = "monster_virus.glb";
    std::string glb10 = "corona_virus_molecules.glb";
    std::string glb11 = "doctor_simi.glb";
    std::string glb12 = "space_maintenance_robot.glb";
    std::string glb13 = "rwby_amity_arena_yang_xiao_long.glb";
    std::string glb14 = "5ec66c72372d4928a67bfb1a23b5a3d1.glb";
    std::string glb15 = "033eeece8fb64f488a97b93122f61e8e.glb";
    std::string glb16 = "protein_sachet.glb";
    std::string glb17 = "xpeng_robot.glb";
    std::string glb18 = "floor_lamp.glb";
    std::string glb19 = "abandoned_warehouse_-_interior_scene.glb";
    std::string glb20 = "swimming_pool_3d_scene.glb";
    // 加载模型（骨骼）与动画（从同一 glb 文件读取）
    std::string glbPath = glb20;
    Model model(glbPath);
    ...
    // ------------------------------------------------------------------
    ModelTrans transmat;
    transmat.translate(glm::vec3(0.0f, 8.0f, 0.0f));
    transmat.rotate(-90.0f, glm::vec3(1.0f, 0.0f, 0.0f));
    glEnable(GL_BLEND);
    // 设置混合函数：源因子(Alpha)和目标因子(1-Alpha)
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    while (window.noClose()) {
        ...
        colorShader.setVec3("lightColor", 1.0f, 0.0f, 0.0f);
